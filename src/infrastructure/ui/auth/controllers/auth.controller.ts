...
// controller shouldn`t extends Interactor, it should just use Interactor
// but in our case we don`t have Presenter, which should extends OutputPort that generated by Interactor
@Controller('auth')
export default class AuthController extends AuthorityInteractor {
  ...
  @Post('signUp')
  signUp(@Body() payload: IUserRegisterDto) {
    return super.signUp(payload);
  }

  @Post('signIn')
  signIn(@Body() payload: IUserLoginDto) {
